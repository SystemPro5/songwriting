...
class AppSettingsPageExample extends StatefulWidget {
  @override
  _AppSettingsPageExampleState createState() => _AppSettingsPageExampleState();
}

class _AppSettingsPageExampleState extends State<AppSettingsPageExample> {
  @override
